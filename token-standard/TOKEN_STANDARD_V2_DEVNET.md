...
Splice version: `0.6.0-snapshot.20260319.2219.0.v95abf08e`
...
1. Any IPs that are allowed in regular DevNet are also allowed in Token-Standard-DevNet,
   ...
   If you anyway need to get a different IP allowed, request it in the [DA Slack channel](https://app.slack.com/client/T03T53E10/C0ANWRU9R9S).
