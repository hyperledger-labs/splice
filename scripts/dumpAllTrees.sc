...
//
// Example usage:
// sbt "apps-app/runMain com.daml.network.CoinApp --config ${CONFIG} --bootstrap ./scripts/dumpAllTrees.sc"
...
Files.write(Paths.get("./log/trees.txt"), content.mkString(System.lineSeparator()).getBytes(StandardCharsets.UTF_8))
