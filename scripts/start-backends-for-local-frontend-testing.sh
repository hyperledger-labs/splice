...
sbt "apps-app/runMain com.daml.network.CoinApp --config ${OUTPUT_CONFIG} --bootstrap ./apps/splitwise/frontend/bootstrap.canton --log-level-canton=DEBUG --log-file-name log/coin.log"
