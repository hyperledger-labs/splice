...
cn-node --config ${OUTPUT_CONFIG} --bootstrap ./apps/splitwell/frontend/bootstrap.sc --log-level-canton=DEBUG --log-encoder json --log-file-name log/cn-node_local_frontend_testing.clog
