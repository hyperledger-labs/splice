...
.. glossary::
  ...
  What would be the best practice to including the ``DAR`` file of token standard into my `daml` project for data-dependencies  to point to?
    ...
    * Put your Daml script tests for your workflow into separate ``*-test`` daml
      projects as done `in splice <https://github.com/hyperledger-labs/splice/tree/b91cf9a77bad6c513658401a57db87d975f9a526/token-standard/splice-token-standard-test-v1>`__.
      See the `daml.yaml <https://github.com/hyperledger-labs/splice/blob/b91cf9a77bad6c513658401a57db87d975f9a526/token-standard/splice-token-standard-test-v1/daml.yaml>`__
      for details.
