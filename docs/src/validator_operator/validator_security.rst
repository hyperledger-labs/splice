...
.. todo::
  Decide on whether to use the "Splice validator" and "splice participant" terms,
  as Martin does here as per his policy
  "In general I'd add "splice" whenever I mean something deployed through our Helm charts and something that is supposed to be used with our code, as both of these restrict the amount of things you can do with, say, a Canton participant.";
  and use them consistently throughout the docs.
