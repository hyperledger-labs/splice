...
.. |splice_url_prefix| replace:: :raw-html:`<span class="splice-url-prefix">unknown_cluster</span>`
.. |gsf_sv_url| replace:: ``https://sv.sv-1.<span class="splice-url-prefix">unknown_cluster</span>global.canton.network.sync.global``
