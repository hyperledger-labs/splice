...
stdenv.mkDerivation rec {
  ...
  src = builtins.fetchurl {
    ...
    sha256 = if stdenv.isDarwin then "sha256:0mzx2bza2dmcnsjil2mb0pcwdhhkxcvchg2f9m08pk5j7qd26g76" else "sha256:1vi81hjpwixgw026ql4mh6ry93961fihdfr5hs7sadlqyxkj623n";
  };
  dontUnpack = true;
  installPhase = ''
    mkdir -p $out/bin
