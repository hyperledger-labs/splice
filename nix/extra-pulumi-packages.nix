  ...
  packages = {
    x86_64-linux = [
      ...
      }
      {
        ...
        sha256 = "bb37f86f9c7633a2b5a84cf6ea48042c604e22657d2414436ae4bf96660214b7";
      }
      {
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-kubernetes-v3.30.1-linux-amd64.tar.gz";
        sha256 = "c2d886dc79df683f80f79e74de065cd11373c51c2508a8f772691b046425bfd2";
      }
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-random-v4.13.2-linux-amd64.tar.gz";
        sha256 = "f34c27e10dbf4ec0302a8dc7cde3aa6f140ca9431067675890b4ad12b09b7a06";
      }
    ];
    x86_64-darwin = [
      {
      ...
      }
      {
        ...
        sha256 = "b192f04122341df3a7f444a1609c23075fdc4213242d25de5b726ae99c6caa9e";
      }
      {
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-kubernetes-v3.30.1-darwin-amd64.tar.gz";
        sha256 = "a99acee17e5f1c2afdc2701df8fae65ed2ba6ee1c1de2c9bbd0d8c37a5eceb5b";
      }
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-random-v4.13.2-darwin-amd64.tar.gz";
        sha256 = "c68ba6043533adc9d2ff30bd9e5e85dd57dbfee4f9b7ee04dde238266f757e9c";
      }
    ];
    aarch64-linux = [
      {
      ...
      }
      {
        ...
        sha256 = "c8fc27ebd418fad92cda49754b00f18228917b044ba5a5dddda825c2653e38ae";
      }
      {
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-kubernetes-v3.30.1-linux-arm64.tar.gz";
        sha256 = "1e271bca2b23eee1cc88dc2352d3a0c14017c9b96d271a684371c242fc29e0a4";
      }
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-random-v4.13.2-linux-arm64.tar.gz";
        sha256 = "04cff775aafb324b70da790d969b8362d4770233d2ddc54e192e047a1381340d";
      }
    ];
    aarch64-darwin = [
      {
      ...
      }
      {
        ...
        sha256 = "8e26dbd4025968bd100c6912359b4b2c69367a125f2ab3c6ccf4295011e1de94";
      }
      {
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-kubernetes-v3.30.1-darwin-arm64.tar.gz";
        sha256 = "edcc43d6a877aeb2a95d407ac55e5ec7d347b63ed144272057eb4463257570fa";
      }
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-random-v4.13.2-darwin-arm64.tar.gz";
        sha256 = "a201fc5f72d434e140f63c3860d01849ebca9fd4578b0d879342999e65b7b062";
      }
    ];
  };
}
