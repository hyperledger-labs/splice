  ...
  steps:
    - name: Restore frontend node_modules
      ...
      with:
        ...
        restore-keys: |
          frontend-npm-install-${{ inputs.cache_version }} branch:${{ github.ref_name }} dependencies:${{ hashFiles('apps/package-lock.json', 'openapi-cache-key.txt', 'project/BuildCommon.scala') }}
