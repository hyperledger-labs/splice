...
find . -name canton -prune -o -name node_modules -prune -o -name daml.js -prune -o -name package.json -exec sed -i "s|@daml/g\(.*\): \".*\"|@daml/\1: \"$SDK_VERSION\"|g" '{}' \; -exec sh -c 'cd $(dirname $1) && npm install' sh '{}' \;
