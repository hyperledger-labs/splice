...
import { readAndParseYaml } from '@lfdecentralizedtrust/splice-pulumi-common/src/config/configLoader';
...
// @ts-ignore
export const gcpProjectConfig = GcpProjectConfigSchema.parse(
  readAndParseYaml(`${configsDir}/config.yaml`)
);
