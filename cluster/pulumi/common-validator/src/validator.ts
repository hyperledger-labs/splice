        ...
        !config.svValidator && config.onboardingSecret
          ? // TODO(#17447): This is a horrible hacky way to test that `valueFrom` does what it should here; this should be removed ASAP.
            [
              ...
              // TODO(#19509): remove this once new cardinality is merged on base image
              {
                name: 'ADDITIONAL_CONFIG_VALIDATOR_CARDINALITY',
                value: 'canton.monitoring.metrics.cardinality=4000',
              },
            ]
          : undefined,
