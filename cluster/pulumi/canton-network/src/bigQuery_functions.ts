...
const all_stats = new BQTableFunction(
  ...
  `
    SELECT
      ...
      \`$$FUNCTIONS_DATASET$$.total_minted\`(as_of_record_time, migration_id) AS minted,
      \`$$FUNCTIONS_DATASET$$.total_minted\`(as_of_record_time, migration_id) + \`$$FUNCTIONS_DATASET$$.unminted\`(as_of_record_time, migration_id) as allowed_mint,
