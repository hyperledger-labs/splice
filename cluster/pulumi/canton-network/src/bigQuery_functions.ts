...
const all_stats = new BQTableFunction(
  ...
  `
    SELECT
      ...
      \`$$FUNCTIONS_DATASET$$.burned\`(as_of_record_time, migration_id) - \`$$FUNCTIONS_DATASET$$.burned\`(TIMESTAMP_SUB(as_of_record_time, INTERVAL 30 DAY), migration_id) as monthly_burn,
