...
const all_stats = new BQTableFunction(
  ...
  [
    ...
    new BQColumn('minted_appRewards', BIGNUMERIC),
    new BQColumn('minted_validatorRewards', BIGNUMERIC),
    new BQColumn('minted_svRewards', BIGNUMERIC),
    new BQColumn('minted_unclaimedActivityRecordAmount', BIGNUMERIC),
  ...
  `
    SELECT
      ...
      \`$$FUNCTIONS_DATASET$$.minted\`(as_of_record_time, migration_id).appRewardAmount as minted_appRewards,
      \`$$FUNCTIONS_DATASET$$.minted\`(as_of_record_time, migration_id).validatorRewardAmount as minted_validatorRewards,
      \`$$FUNCTIONS_DATASET$$.minted\`(as_of_record_time, migration_id).svRewardAmount as minted_svRewards,
      \`$$FUNCTIONS_DATASET$$.minted\`(as_of_record_time, migration_id).unclaimedActivityRecordAmount as minted_unclaimedActivityRecordAmount,
