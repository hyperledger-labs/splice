...
istioVirtualService('prometheus', 'prometheus-prometheus', 9090);

istioVirtualService('grafana', 'grafana', 80);
        ...
        http: [
          {
            ...
            route: [
              {
                destination: {
                  host: pulumi.interpolate`${serviceName}.${namespaceName}.svc.cluster.local`,
                  port: {
                    number: servicePort,
                  },
                },
