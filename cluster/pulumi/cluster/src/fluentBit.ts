...
import { appsAffinityAndTolerations, CLUSTER_NAME, exactNamespace, GCP_REGION, infraAffinityAndTolerations } from 'splice-pulumi-common';


export function installFluentBit() {
