...
* Deployment
    ...
    * The SV Helm runbook has been extended with a section that explains :ref:`how to restore from a participant identities backup <participant-identities-restore>`.
