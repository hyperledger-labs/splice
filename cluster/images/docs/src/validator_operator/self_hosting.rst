...
.. parsed-literal::
    ...
    DOMAIN_URL=https://sequencer.sv-1.svc.|cn_cluster|.network.canton.global ../|canton_subdir|/bin/canton --config examples/validator/validator-participant.conf --config examples/validator/validator-participant-bootstrapping.conf
