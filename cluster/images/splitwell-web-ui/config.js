...
window.splice_config = {
  ...
  spliceInstanceNames: {
    networkName: "${CN_APP_SPLITWELL_UI_NETWORK_NAME}",
    amuletName: "${CN_APP_SPLITWELL_UI_AMULET_NAME}",
    amuletNameAcronym: "${CN_APP_SPLITWELL_UI_AMULET_NAME_ACRONYM}",
    nameServiceName: "${CN_APP_SPLITWELL_UI_NAME_SERVICE_NAME}",
    nameServiceNameAcronym: "${CN_APP_SPLITWELL_UI_NAME_SERVICE_NAME_ACRONYM}",
  },
};
