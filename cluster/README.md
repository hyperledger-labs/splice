...
All of these scripts must be run from within the project directory
hierarchy, and none of them take command line arguments of any kind.
...
* `cluster-apply` - Apply the configuration from
  `canton-network-config.jsonnet` into the cluster.
