...
export const svcInfo: GetSvcInfoResponse = {
  ...
  svc_rules: {
    template_id:
      'b71a4deb943e8f7f27bb7a384c1b8da8a88f5cd40f92d5b1b56b97f1cb379f27:CN.SvcRules:SvcRules',
    contract_id:
...
if (!result.ok) {
  throw new Error(`Invalid SvcInfo mock: ${result.error}`);
}

export const svPartyId = svcInfo.sv_party_id;
