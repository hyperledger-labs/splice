...
/** A codec for converting [[com.daml.ledger.javaapi.data.Value]] to/from JSON strings.
  ...
  *   See [[org.lfdecentralizedtrust.splice.util.ContractCompanions.allDecoders]] for the list of supported templates.
  ...
  *  and the decoding part in [[org.lfdecentralizedtrust.splice.util.TemplateJsonDecoder]].
  */
