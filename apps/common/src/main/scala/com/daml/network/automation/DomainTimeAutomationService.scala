...
import com.daml.network.store.{DomainTimeSynchronization, DomainTimeStore}
...
final class DomainTimeAutomationService(
    ...
    extends AutomationService(config, clock, DomainTimeSynchronization.Noop, retryProvider) {
