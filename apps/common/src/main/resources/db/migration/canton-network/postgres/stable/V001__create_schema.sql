...
create table txlog_store_template_new(
    -- The id of the store that this TxLog entry belongs to
    store_id int not null,
    ...
    -- For entries generated from daml transactions: the offset of the transaction
    -- For entries generated from ACS contracts: the offset of the ACS snapshot
    transaction_offset text not null,

    -- For entries generated from daml transactions: the domain on which the transaction was processed
    -- For entries generated from ACS contracts: the domain to which the contract was assigned at the time of the ACS snapshot
    domain_id text not null,

    -- For entries generated from daml transactions: NULL
    -- For entries generated from ACS contracts: the id of the contract that generated this entry
    acs_contract_id text,
...
create index txlog_store_template_new_sid_et
    on txlog_store_template_new (store_id, entry_type);
