...
-- Note: the only operation that we need to support efficiently is streaming updates for a given history between two given offsets
create index updt_hist_assi_ni_di_rt on update_history_assignments (history_id, migration_id, participant_offset);
...
-- Note: the only operation that we need to support efficiently is streaming updates for a given history between two given offsets
create index updt_hist_unas_ni_di_rt on update_history_unassignments (history_id, migration_id, participant_offset);
