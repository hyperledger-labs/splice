-- State of incremental ACS snapshots
...
create index acs_incremental_snapshot_data_next_ca_ci
    on acs_incremental_snapshot_data_next (snapshot_id, created_at, contract_id);
...
create index acs_incremental_snapshot_data_backfill_ca_ci
    on acs_incremental_snapshot_data_backfill (snapshot_id, created_at, contract_id);
