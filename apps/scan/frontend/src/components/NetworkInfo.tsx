...
const FeesTable: React.FC<{
  ...
  const holdingFeesDescription = `A fixed fee for maintaining each active ${amuletName} record, computed per round, but only charged if it surpasses the ${amuletName} amount.`;
