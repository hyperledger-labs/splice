      ...
      withS3Mock(loggerFactory) { (bucketConnection: S3BucketConnection) =>
        ...
        clue(
          ...
          probe.expectNext(20.seconds) should be(
            (segment, "TimestampWithMigrationId(1970-01-01T00:00:00.100Z,0)-TimestampWithMigrationId(1970-01-01T00:00:02.300Z,0)/updates_0.zstd")
          )
          probe.expectNext(20.seconds) should be(
            (segment, "TimestampWithMigrationId(1970-01-01T00:00:00.100Z,0)-TimestampWithMigrationId(1970-01-01T00:00:02.300Z,0)/updates_1.zstd")
          )
