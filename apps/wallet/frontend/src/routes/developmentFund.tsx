...
import {
  DevelopmentFundProvider,
  useDevelopmentFundContext,
} from '../contexts/DevelopmentFundCouponsContext';

const DevelopmentFundContent: React.FC = () => {
  const { isFundManager, isLoading } = useDevelopmentFundContext();
