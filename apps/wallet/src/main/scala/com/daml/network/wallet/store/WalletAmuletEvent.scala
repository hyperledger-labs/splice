...
object AcceptedTransferOffer_Complete extends ExerciseNodeCompanion {
  ...
  override type Res = daTypes.Tuple2[
    daTypes.Tuple2[amuletrulesCodegen.TransferResult, transferCodegen.TransferOfferTrackingInfo],
    java.util.Optional[
  ...
  override val resDecoder = daTypes.Tuple2.valueDecoder(
    daTypes.Tuple2.valueDecoder(
      amuletrulesCodegen.TransferResult.valueDecoder(),
    ...
    x =>
      x.asOptional()
        .get
        .getValue
        .map(cid => new amuletCodegen.Amulet.ContractId(cid.asContractId().get.getValue)),
  )
...
object WalletAppInstall_CreateBuyTrafficRequest extends ExerciseNodeCompanion {
  ...
  override type Res = trafficRequestCodegen.BuyTrafficRequest.ContractId
  ...
  override val resDecoder = result =>
    new trafficRequestCodegen.BuyTrafficRequest.ContractId(result.asContractId().get.getValue)
  override def resToValue(res: Res) = res.toValue
}
...
object BuyTrafficRequest_Complete extends ExerciseNodeCompanion {
  ...
  override type Res = daTypes.Tuple2[
    daTypes.Tuple2[MemberTraffic.ContractId, trafficRequestCodegen.BuyTrafficRequestTrackingInfo],
    java.util.Optional[
      amuletCodegen.Amulet.ContractId
    ],
  ]
  ...
  override val resDecoder = daTypes.Tuple2.valueDecoder(
    daTypes.Tuple2.valueDecoder(
      ...
      trafficRequestCodegen.BuyTrafficRequestTrackingInfo.valueDecoder(),
    ),
    x =>
      x.asOptional()
        .get
  ...
  override def resToValue(res: Res) =
    res.toValue(
      _.toValue(_.toValue, _.toValue),
      x => DamlOptional.of(x.map(_.toValue): Optional[Value]),
    )
}
...
case object BuyTrafficRequest_Cancel extends ExerciseNodeCompanion {
  ...
  override type Res = trafficRequestCodegen.BuyTrafficRequestTrackingInfo
  ...
  override val resDecoder = trafficRequestCodegen.BuyTrafficRequestTrackingInfo.valueDecoder()
  override def resToValue(res: Res) = res.toValue
}
...
object SubscriptionInitialPayment_Collect extends ExerciseNodeCompanion {
  ...
  override val resDecoder = daTypes.Tuple3.valueDecoder(
    ...
    cid => new amuletCodegen.Amulet.ContractId(cid.asContractId().get().getValue),
  )
...
object SubscriptionPayment_Reject extends ExerciseNodeCompanion {
  ...
  override type Res = daTypes.Tuple2[
    subsCodegen.SubscriptionIdleState.ContractId,
    amuletCodegen.AmuletCreateSummary[amuletCodegen.Amulet.ContractId],
  ]
