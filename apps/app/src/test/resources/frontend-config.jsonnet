...
local validatorNodes(clusterAddress) = {
  alice: {
    ...
    wallet: { url: "http://localhost:5204", uiUrl: "http://localhost:3000" },
  ...
  bob: {
    ...
    wallet: { url: "http://localhost:5304", uiUrl: "http://localhost:3001" },
    splitwell: { url: "http://localhost:6113" },
    directory: { url: "http://localhost:5110", jsonApiUrl: "http://localhost:3004/api/json-api/" },
    scan: { url: "http://localhost:5012" },
  },
  preflight: {
    ...
    wallet: { url: "http://localhost:5004", uiUrl: "http://localhost:3000" },
    splitwell: { url: "http://localhost:6113" },
