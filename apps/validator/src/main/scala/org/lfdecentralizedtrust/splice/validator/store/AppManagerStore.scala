...
import org.lfdecentralizedtrust.splice.codegen.java.splice.appmanager.store as codegen
...
import org.lfdecentralizedtrust.splice.util.JsonUtil.circeJsonToSprayJsValue
...
final class AppManagerStore(
  ...
  def storeAppRelease(release: AppRelease, priority: CommandPriority = CommandPriority.Low)(implicit
    ...
    idempotentCreate(
      ...
      SpliceLedgerConnection.CommandId(
        "org.lfdecentralizedtrust.splice.validator.store.storeAppRelease",
  ...
  def storeAppConfiguration(
    ...
    idempotentCreate(
      ...
      SpliceLedgerConnection.CommandId(
        "org.lfdecentralizedtrust.splice.validator.store.storeAppConfiguration",
  ...
  def storeRegisteredApp(
    ...
    idempotentCreate(
      ...
      SpliceLedgerConnection.CommandId(
        "org.lfdecentralizedtrust.splice.validator.store.storeRegisteredApp",
  ...
  def storeInstalledApp(installed: InstalledApp)(implicit tc: TraceContext): Future[Unit] =
    idempotentCreate(
      ...
      SpliceLedgerConnection.CommandId(
        "org.lfdecentralizedtrust.splice.validator.store.storeInstalledApp",
  ...
  def storeApprovedReleaseConfiguration(releaseConfiguration: ApprovedReleaseConfiguration)(implicit
    ...
    idempotentCreate(
      ...
      SpliceLedgerConnection.CommandId(
        "org.lfdecentralizedtrust.splice.validator.store.storeApprovedReleaseConfiguration",
